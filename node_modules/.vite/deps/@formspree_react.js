...
var require_dist = __commonJS({
  "node_modules/@formspree/core/dist/index.js"(exports, module) {
    ...
    var K2 = (e, r, t, o) => {
      if (r && typeof r == "object" || typeof r == "function") for (let s of V2(r)) !L.call(e, s) && s !== t && g(e, s, { get: () => r[s], enumerable: !(o = j2(r, s)) || o.enumerable });
      return e;
    };
    ...
    var W2 = {};
    Y2(W2, { SubmissionError: () => p, appendExtraData: () => E2, createClient: () => R2, getDefaultClient: () => U, isSubmissionError: () => A2 });
    module.exports = $2(W2);
            ...
            return h2(this, null, function* () {
              try {
                ...
                if (M2(n)) {
                  ...
                  if (w2(n)) return new S2({ next: n.next });
                }
...
function V(e) {
  ...
  return n.length === 0 ? null : import_react2.default.createElement("div", { ...s }, t ? `${t} ` : null, n.map((a) => a.message).join(", "));
}
var E = (0, import_react5.createContext)({ elements: null });
function P(e) {
  let { children: t } = e, r = useElements();
  return import_react4.default.createElement(E.Provider, { value: { elements: r } }, t);
}
function v() {
  return (0, import_react5.useContext)(E);
}
var h = import_react3.default.createContext(null);
function N(e) {
  let { children: t, project: r, stripePK: o } = e, [s, n] = (0, import_react3.useState)((0, import_core.createClient)({ project: r })), a = (0, import_react3.useMemo)(() => o ? (0, import_pure.loadStripe)(o) : null, [o]);
  return (0, import_react3.useEffect)(() => {
    let i = true;
    return i && n((l) => l.project !== r ? (0, import_core.createClient)({ ...l, project: r }) : l), () => {
      i = false;
    };
  }, [r]), (0, import_react3.useEffect)(() => {
    let i = true;
    return a == null ? void 0 : a.then((l) => {
      i && l && n((p) => (0, import_core.createClient)({ ...p, stripe: l }));
    }), () => {
      i = false;
    };
  }, [a]), import_react3.default.createElement(h.Provider, { value: { client: s } }, a ? import_react3.default.createElement(Elements, { stripe: a }, import_react3.default.createElement(P, null, t)) : t);
}
function b() {
  return (0, import_react3.useContext)(h) ?? { client: (0, import_core.getDefaultClient)() };
}
var D = "3.0.0";
...
function F(e, t = {}) {
  ...
  return async function(p) {
    ...
    let c = a == null ? void 0 : a.getElement(CardElement), x = i && c ? () => i.createPaymentMethod({ type: "card", card: c, billing_details: G(m) }) : void 0;
...
function J(e, t = {}) {
  let [r, o] = (0, import_react6.useState)(null), [s, n] = (0, import_react6.useState)(null), [a, i] = (0, import_react6.useState)(false), [l, p] = (0, import_react6.useState)(false);
